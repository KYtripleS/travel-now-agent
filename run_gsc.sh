...
# Daily CEO dashboard (composes GSC+GA4 into one executive report; v2 mandate #9)
/Users/ky/anaconda3/bin/python3 ceo_dashboard.py >> ga4_reports/cron.log 2>&1 || true
