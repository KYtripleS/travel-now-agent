...
SHARED: dict[str, dict] = {
    "japan-photo":          dict(bullets=["History & geography", "Politics & economy", "Society & culture", "Travel prep checklist"], cta="Read the full profile →", urlHint="gentlyyonder • countries/japan", articleUrl="https://gentlyyonder.com/countries/japan/"),
    "vietnam-photo":        dict(bullets=["Geography & climate", "Modern economy", "Food & street culture", "Travel prep checklist"], cta="Read the full profile →", urlHint="gentlyyonder • countries/vietnam", articleUrl="https://gentlyyonder.com/countries/vietnam/"),
    "australia-photo":      dict(bullets=["History & geography", "Politics & economy", "Society & culture", "Travel prep checklist"], cta="Read the full profile →", urlHint="gentlyyonder • countries/australia", articleUrl="https://gentlyyonder.com/countries/australia/"),
    "tokyo-photo":          dict(bullets=["History & neighborhoods", "Modern districts", "Food & culture", "Practical prep"], cta="Read the full guide →", urlHint="gentlyyonder • cities/tokyo", articleUrl="https://gentlyyonder.com/cities/tokyo/"),
    "asakusa-photo":        dict(bullets=["Sensoji temple history", "Edo-era streets", "Practical visit tips", "Nearby districts"], cta="Read the neighborhood guide →", urlHint="gentlyyonder • cities/tokyo/asakusa", articleUrl="https://gentlyyonder.com/cities/tokyo/asakusa.html"),
    "airport-liquids-photo": dict(bullets=["100ml rule basics", "Clear plastic bag tips", "Common rejections", "Quick FAQ"], cta="Read the checklist →", urlHint="gentlyyonder • airport-security-liquids", articleUrl="https://gentlyyonder.com/articles/airport-security-liquids.html"),
    "carry-on-photo":       dict(bullets=["Liquids on top", "Laptop accessible", "Passport in pocket", "Charger logic"], cta="Read the prep guide →", urlHint="gentlyyonder • airport-security-packing", articleUrl="https://gentlyyonder.com/articles/airport-security-packing-moments.html"),
    "beach-photo":          dict(bullets=["Reef-safe sunscreen", "Packable sun hats", "Quick-dry towels", "Forgotten essentials"], cta="Read the checklist →", urlHint="gentlyyonder • beach-trip-packing", articleUrl="https://gentlyyonder.com/articles/beach-trip-packing-checklist.html"),
    "boat-day-photo":       dict(bullets=["UK, Italy, France rules", "Spain, Croatia, Greece", "Platforms & costs", "What to bring"], cta="Read the full guide →", urlHint="gentlyyonder • charter-a-boat-for-a-day", articleUrl="https://gentlyyonder.com/articles/charter-a-boat-for-a-day.html"),
    "esim-photo":           dict(bullets=["Phone compatibility", "Choosing a data plan", "Offline backup tips", "Pre-flight checklist"], cta="Read the setup guide →", urlHint="gentlyyonder • esim-activation", articleUrl="https://gentlyyonder.com/articles/esim-activation-and-preparation.html"),
    "travel-edc-photo":     dict(bullets=["Power bank", "Water bottle", "Hand sanitizer", "Small cash"], cta="Read the checklist →", urlHint="gentlyyonder • everyday-carry-essentials", articleUrl="https://gentlyyonder.com/articles/everyday-carry-essentials-for-travel.html"),
    "hotels-photo":         dict(bullets=["Hotels.com vs Booking", "Trip.com & Agoda", "HotelsCombined logic", "Common booking mistakes"], cta="Read the comparison →", urlHint="gentlyyonder • hotel-booking-sites", articleUrl="https://gentlyyonder.com/articles/hotel-booking-sites-comparison.html"),
    "untranslatable-photo": dict(bullets=["Saudade, Hygge, Wabi-sabi", "Why they resist English", "What linguists say", "What travelers take home"], cta="Read the full essay →", urlHint="gentlyyonder • untranslatable-words", articleUrl="https://gentlyyonder.com/articles/untranslatable-words.html"),
    "etiquette-photo":      dict(bullets=["Face & politeness theory", "Greeting conventions", "Dining manners", "Public space norms"], cta="Read the cultural guide →", urlHint="gentlyyonder • what-counts-as-rude", articleUrl="https://gentlyyonder.com/articles/what-counts-as-rude.html"),
    "south-korea-photo":    dict(bullets=["History & geography", "Politics & economy", "Society & culture", "Travel prep checklist"], cta="Read the full profile →", urlHint="gentlyyonder • south-korea-country-profile", articleUrl="https://gentlyyonder.com/articles/south-korea-country-profile.html"),
    "insurance-photo":      dict(bullets=["Provider archetypes", "Coverage & exclusions", "Claims process", "Decision framework"], cta="Read the comparison →", urlHint="gentlyyonder • travel-insurance-compared", articleUrl="https://gentlyyonder.com/articles/travel-insurance-compared.html"),
    "capsule-photo":        dict(bullets=["Core 10 pieces", "Fabric choices", "Layering logic", "Laundry strategy"], cta="Read the packing guide →", urlHint="gentlyyonder • capsule-wardrobe", articleUrl="https://gentlyyonder.com/articles/capsule-wardrobe-2-week-trips.html"),
}
