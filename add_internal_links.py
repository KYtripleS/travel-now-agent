...
ARTICLES: dict[str, tuple[str, str]] = {
    ...
    "articles/where-to-book-taipei-day-tour.html": (
        "Where to Book a Taipei Day Tour",
        "KKday is Taiwanese and carries the deeper inventory; Klook's north-coast listings commonly include Yehliu entry. The gap is under 5%.",
    ),
    "articles/where-to-book-bangkok-dinner-cruise.html": (
        "Where to Book a Bangkok Dinner Cruise",
        "KKday for the cheapest Chao Phraya boats; Klook for the headline vessels and clearer piers \u2014 but the sunset departure saves more than either.",
    ),
    ...
    "articles/is-accommodation-tax-double-taxation.html": (
        ...
        "Consumption tax plus a lodging tax on one stay — the academically grounded, balanced answer.",
    ),
    "articles/does-tourist-tax-reduce-overtourism.html": (
        "Does a Tourist Tax Reduce Overtourism?",
        "Cities tax visitors in the name of crowds — but the demand economics says it mostly raises revenue, not cuts numbers.",
    ),
    "articles/is-the-weak-yen-a-bargain-or-trap.html": (
        "Is the Weak Yen a Bargain or a Trap?",
        "The yen makes Japan 20-30% cheaper — but taxes, dual pricing, and a tripled departure tax claw some of it back.",
    ),
    "articles/is-travel-insurance-a-rip-off.html": (
        "Is Travel Insurance a Rip-Off?",
        "A losing bet on average, yet a rational buy — the economics of when insurance is worth it and when it's a waste.",
    ),
